...
if (isset($_POST["filter1"])) {
    ...
    foreach ($data as $value) {
        ...
        if (($_POST["city"] == "" )&&($_POST["type"] == $value->Tipo) && ($price > $range[0] && $price < $range[1])){
            $dataFilter[] = array(
                "Direccion" => $value->Direccion,
                "Ciudad" => $value->Ciudad,
                "Telefono" => $value->Telefono,
        ...
        if (($_POST["city"] == $value->Ciudad) && ($_POST["type"] == "") && ($price > $range[0] && $price < $range[1])) {
            $dataFilter[] = array(
                "Direccion" => $value->Direccion,
                "Ciudad" => $value->Ciudad,
                "Telefono" => $value->Telefono,
        ...
        if (($_POST["city"] == "") && ($_POST["type"] == "") && ($price > $range[0] && $price < $range[1])) {
            $dataFilter[] = array(
                "Direccion" => $value->Direccion,
                "Ciudad" => $value->Ciudad,
                "Telefono" => $value->Telefono,
